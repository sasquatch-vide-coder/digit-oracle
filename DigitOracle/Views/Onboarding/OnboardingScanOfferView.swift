...
struct OnboardingScanOfferView: View {
    ...
    var body: some View {
        VStack(spacing: 28) {
            ...
            Text("Dost thou already possess visions of thy sacred numbers? Let the Oracle seek them within thy archive.")
                .font(.subheadline)
            ...
            Button {
                ...
                Label("Begin the Search", systemImage: "magnifyingglass")
                    .font(.headline)
                    .foregroundStyle(.white)
                    .frame(maxWidth: .infinity)
                    .padding(.vertical, 16)
