        ...
        ScrollView {
            if album.sightings.isEmpty {
                ContentUnavailableView(
                    ...
                    description: Text("Tap + to add visions to this scroll.")
                )
                .padding(.top, 60)
            } else {
            ...
            Group {
                if availableSightings.isEmpty {
                    ContentUnavailableView(
                        ...
                        description: Text("Every vision is already in this scroll.")
                    )
                } else {
                        ...
                        Button {
                            ...
                            HStack {
                                ...
                                VStack(alignment: .leading, spacing: 2) {
                                    Text(sighting.notes.isEmpty ? "Vision" : sighting.notes)
                                        .font(.subheadline)
