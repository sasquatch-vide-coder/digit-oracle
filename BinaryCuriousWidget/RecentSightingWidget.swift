...
struct RecentSightingWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("Recent Sighting")
        .description("Shows a random sighting with its photo.")
...
struct RecentSightingView: View {
    ...
    private func imageWidget(uiImage: UIImage) -> some View {
        ...
        .widgetURL(URL(string: "binarycurious://sightings"))
    }
