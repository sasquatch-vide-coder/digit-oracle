...
enum ChallengeTemplates {
    ...
    static let daily: [ChallengeTemplate] = [
        ChallengeTemplate(title: "Quick Spot", description: "Capture any sighting today", category: nil, requiresVerified: false, requiresLocation: false, minRarity: nil, timeWindow: "daily", reward: .none),
        ChallengeTemplate(title: "Verified Find", description: "Capture an OCR-verified sighting", category: nil, requiresVerified: true, requiresLocation: false, minRarity: nil, timeWindow: "daily", reward: .streakFreeze(1)),
